      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 min-h-full flex items-center py-8">
        <div className="max-w-5xl mx-auto text-center w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-8 px-4">
            <Button variant="hero" size="sm" className="w-full sm:w-auto min-w-44 bg-purple-600 hover:bg-purple-700 text-white text-sm sm:text-base px-6 py-3 h-auto" onClick={handleStartStudying}>
              Start Studying Now
              <ArrowRight className="h-4 w-4 ml-2" />
            </Button>
            <Button variant="outline" size="sm" className="w-full sm:w-auto min-w-44 border-2 border-gray-600 bg-gray-900/50 hover:bg-gray-800/50 text-gray-200 text-sm sm:text-base px-6 py-3 h-auto" onClick={handleSeeHowItWorks}>
              See How It Works
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 px-2 sm:px-4">
            <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-gray-700/60 hover:bg-gray-900/80 transition-all duration-300 shadow-lg text-center">
              <div className="bg-purple-900/50 p-3 rounded-lg w-fit mx-auto mb-3">
                <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-purple-400" />
              </div>
              <h3 className="font-semibold text-white mb-2 text-sm sm:text-base">Upload & Generate</h3>
            ...
            <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-gray-700/60 hover:bg-gray-900/80 transition-all duration-300 shadow-lg text-center">
              <div className="bg-blue-900/50 p-3 rounded-lg w-fit mx-auto mb-3">
                <Brain className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400" />
              </div>
              <h3 className="font-semibold text-white mb-2 text-sm sm:text-base">Smart Quizzing</h3>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-gray-700/60 hover:bg-gray-900/80 transition-all duration-300 shadow-lg text-center">
              <div className="bg-yellow-900/50 p-3 rounded-lg w-fit mx-auto mb-3">
                <Zap className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-400" />
              </div>
              <h3 className="font-semibold text-white mb-2 text-sm sm:text-base">Instant Doubts</h3>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
